...
quociente da divisão de dois números como a quantidade de vezes que podemos retirar o divisor do dividendo. Logo,
20 ÷ 4 = 5, uma vez que podemos subtrair 4 cinco vezes de 20."""

dividendo = int(input("Dividendo [Inteiro]: "))
divisor = int(input("Divisor [inteiro]: "))
quociente = 0
x = dividendo
